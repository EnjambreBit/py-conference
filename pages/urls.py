...
urlpatterns = [
    ...
    path("accounts/change-password/", PasswordChangeView.as_view(template_name='account/change-password.html'), name="change_password"),
    path('accounts/change-password/done/', PasswordChangeDoneView.as_view(template_name='account/change-password-done.html'), name = 'password_change_done'),
