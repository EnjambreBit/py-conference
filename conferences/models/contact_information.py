...
class ContactInformation(models.Model):
    profile = models.OneToOneField(
        "Profile", related_name="contact_information", on_delete=models.CASCADE
    )
    ...
    state = models.CharField(
        "State/Province/Region", max_length=200, default=None, blank=True, null=True
    )
    zip_code = models.CharField(max_length=20, default=None, blank=True, null=True)
    country = models.ForeignKey(
        "Country", related_name="contact_information", on_delete=models.CASCADE
    )
