...
class TalkRoom(models.Model):
    talk = models.ForeignKey("Talk", related_name="talks_rooms", on_delete=models.CASCADE)
    room = models.ForeignKey("Room", related_name="talks_rooms", on_delete=models.CASCADE)
